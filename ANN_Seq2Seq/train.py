...
def main():
    ...
    print("[EN_vocab]:%d [ZH_vocab]:%d" % (de_size, en_size))
    ...
    for e in range(1, args.epochs+1):
        ...
        if not best_val_loss or val_loss < best_val_loss:
            print("[!] saving model...")
            if not os.path.isdir("save_batchsize2046"):
                os.makedirs("save_batchsize2046")
            torch.save(seq2seq.state_dict(), './save_batchsize2046/seq2seq_%d.pt' % (e))
